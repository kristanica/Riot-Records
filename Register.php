<?php
include_once __DIR__ . "/php/CRUD/register.php";
?>
...
<body class="min-h-screen min-w-screen bg-[#0d0d10] text-zinc-100 flex-col font-exo flex justify-center items-center">
    ...
    <main class="w-full max-w-md px-6">
        ...
        <form method="post" class="bg-[#15151b]/80 rounded-2xl mt-6 p-8 border border-white/10">
            ...
            <div class="mt-6">
                <label class="pl-1 text-[11px] uppercase tracking-[0.3em] text-zinc-400">Username</label>
                <div class="mt-2">
                    <input class="w-full px-4 py-3 rounded-lg bg-transparent text-white border border-white/10 focus:border-[#ff4d5a] focus:ring-2 focus:ring-[#ff4d5a]/20 outline-none" name="username" type="text" required>
                </div>
            </div>
            ...
            <div class="mt-4">
                <label class="pl-1 text-[11px] uppercase tracking-[0.3em] text-zinc-400">Confirm password</label>
                <div class="mt-2">
                    <input class="w-full px-4 py-3 rounded-lg bg-transparent text-white border border-white/10 focus:border-[#ff4d5a] focus:ring-2 focus:ring-[#ff4d5a]/20 outline-none" name="confirmPassword" type="password" required>
                </div>
            </div>

            <div class="mt-6 text-center">
                <button type="submit" name="register" class="w-full rounded-full border border-white/20 px-6 py-3 text-[11px] uppercase tracking-[0.35em] text-white hover:border-[#ff4d5a] hover:text-[#ff4d5a] transition">Create account</button>
            </div>
        </form>
